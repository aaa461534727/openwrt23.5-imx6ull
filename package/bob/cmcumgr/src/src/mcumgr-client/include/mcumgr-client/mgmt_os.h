 ...
 * @return size_t  The size of the request stored in @p buf or -ENOBUFS, if the supplied buffer is to short for the encoded
 */
size_t mgmt_create_os_echo_req(uint8_t *buf, size_t sz, const struct mgmt_echo_req *req);
 ...
 * @return size_t  The size of the request stored in @p buf or -ENOBUFS, if the supplied buffer is to short for the encoded
 */
size_t mgmt_create_os_reset_req(uint8_t *buf, size_t sz);
